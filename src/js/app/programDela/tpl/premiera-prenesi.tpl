...
<tbody>
    <tr>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.Do.nasDelez}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.Do.avtorskiHonorarji}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.Do.tantieme}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.Do.avtorskePravice}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.stHonorarnih 0}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.stHonorarnihIgr 0}}</td>
    </tr>
    <tr>
        <td>
            <input class="stHonorarnihIgr" type="checkbox">
    ...
    <tr>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.stHonorarnihIgrTujJZ 0}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.stHonorarnihIgrSamoz 0}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" rpc.stZaposUmet 0}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "date" rpc.datumZacStudija}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "date" rpc.datumPremiere}}</td>
    </tr>
</tbody>
