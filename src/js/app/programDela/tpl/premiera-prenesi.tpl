...
<tbody>
    <tr>
        ...
        <td class="col-numbers">{{u "formatNumber" uprizoritevData.Do.nasDelez}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" uprizoritevData.Do.avtorskiHonorarji}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" uprizoritevData.Do.tantieme}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" uprizoritevData.Do.materialni}}</td>
    </tr>
    <tr>
        <td>
        ...
        <td class="col-numbers">{{u "formatNumber" uprizoritevData.Do.avtorskePravice}}</td>
    </tr>
    <tr>
        <td>
