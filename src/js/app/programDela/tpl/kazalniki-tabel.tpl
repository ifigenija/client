...
<table class="table table-striped table-condensed">
    <thead>
        <tr>
            ...
            <th class="col-sm-3 col-numbers">{{t "programDela.nacrtovano"}}</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <tr><!--možna decimalna števila-->
            <td class="kazalnik-padleft">{{t "programDela.d.vrPS1Do"}}</td>
            <td class="col-numbers">{{u "formatNumber" vrPS1Do}}</td>
        </tr>
        <tr><!--možna decimalna števila-->
            <td class="kazalnik-padleft">{{t "programDela.d.vrPS1Mat"}}</td>
            <td class="col-numbers">{{u "formatNumber" vrPS1Mat}}</td>
        </tr>
        <tr><!--možna decimalna števila-->
            <td class="kazalnik-padleft">{{t "programDela.d.vrPS1GostovSZ"}}</td>
