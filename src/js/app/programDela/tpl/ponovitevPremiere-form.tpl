    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6" data-fields="avtorskiHonorarji,avtorskiHonorarjiSamoz,materialni,tantieme"></div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-12 col-lg-6" data-fields="zaproseno,avtorskePravice,drugiJavni,celotnaVrednostGostovSZ,vlozekGostitelja"></div>
                <div class="col-sm-12 col-lg-6" data-fields="stHonorarnih,obiskDoma,obiskGost,obiskZamejo"></div>
            </div>
        </div>
    </div>
    <div class="row">
