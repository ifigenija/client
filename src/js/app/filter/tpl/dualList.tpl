<div class="duallist-backdrop"></div>
<div class="duallist-content">
    <div class="panel panel-default panel-form glava-panel">
        <div class="panel-heading">
            <h4 class="duallist-naslov">{{title}}</h4>
        </div>
        <div class="panel-body duallist-body">
            <div class="row">
                <div class="coll-xs-12 duallist-filter"></div>
            </div>
            <div class="row duallist-seznama">
                <div class="col-xs-5">
                ...
                <div class="col-xs-5 duallist-seznam-desni"></div>
            </div>
        </div>
    </div>
</div>